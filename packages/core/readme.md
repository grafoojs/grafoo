...
This method receives as arguments a query object created with the `@grafoo/core/tag` template tag and a GraphQL variables object. It returns a promise that will resolve with the data requested or reject with an list of GraphQL errors.
